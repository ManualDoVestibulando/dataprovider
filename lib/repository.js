    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, zip.extract("data-main/filetree/", filepath)];
            case 1:
                _a.sent();
...
var pathIsDir = function (filepath) { return fs_1.default.lstatSync(filepath).isDirectory(); };
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                ...
                _c = {};
                return [4 /*yield*/, pathListDirs(filepath).mapAwait(function (campuspath) { return __awaiter(void 0, void 0, void 0, function () {
                        var _a, _b;
                        var _c;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0:
                                    _a = [{}];
                                    return [4 /*yield*/, readFileAndParseIndex(campuspath)];
                                case 1:
                                    _b = [__assign.apply(void 0, _a.concat([(_d.sent())]))];
                                    _c = {};
                                    return [4 /*yield*/, pathListDirs(campuspath).mapAwait(function (institutopath) { return __awaiter(void 0, void 0, void 0, function () {
                                            var _a, _b;
                                            var _c;
                                            return __generator(this, function (_d) {
                                                switch (_d.label) {
            ...
            case 2: return [2 /*return*/, __assign.apply(void 0, _b.concat([(_c.campus = _d.sent(), _c)]))];
        }
    });
}); };
